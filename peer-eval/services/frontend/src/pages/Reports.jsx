    ...
    try {
      ...
      switch (activeTab) {
        case 'project':
          ...
          response = await reportsAPI.project(selectedProject);
          break;
        case 'team':
          if (!selectedTeam) {
          ...
          response = await reportsAPI.team(selectedTeam);
          break;
        case 'user':
          if (!selectedUser) {
          ...
          response = await reportsAPI.user(selectedUser);
          break;
        case 'form':
          if (!selectedForm) {
          ...
          response = await reportsAPI.form(selectedForm);
          break;
        default:
          setLoading(false);
          return;
